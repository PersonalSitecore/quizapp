...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.headlessapp.localhost/ --auth https://id.headlessapp.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.headlessapp.localhost/ --auth https://id.headlessapp.localhost/ --allow-write true
}
...
Start-Process https://cm.headlessapp.localhost/sitecore/
Start-Process https://www.headlessapp.localhost/
