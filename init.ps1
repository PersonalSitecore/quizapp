...
Add-HostsEntry "cm.headlessapp.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.headlessapp.localhost"
}
Add-HostsEntry "id.headlessapp.localhost"
Add-HostsEntry "www.headlessapp.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.headlessapp.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.headlessapp.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.headlessapp.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.headlessapp.localhost"
